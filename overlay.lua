...
capLabel:SetPoint("TOPLEFT", Frame, "TOPLEFT", PAD, -59)
...
capRight:SetPoint("TOPRIGHT", Frame, "TOPRIGHT", -PAD, -59)
...
capBarBg:SetPoint("TOPLEFT", Frame, "TOPLEFT", PAD, -71)
...
div2:SetHeight(1)
div2:SetPoint("TOPLEFT", Frame, "TOPLEFT", PAD, -83)

-- ===== Rework Notice =====
local noticeText = Frame:CreateFontString(nil, "OVERLAY")
noticeText:SetFont("Fonts\\FRIZQT__.TTF", 8)
noticeText:SetPoint("TOPLEFT",  Frame, "TOPLEFT",  PAD, -88)
noticeText:SetPoint("TOPRIGHT", Frame, "TOPRIGHT", -PAD, -88)
